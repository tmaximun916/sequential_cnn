...
model = Sequential([
  ...
  layers.Conv2D(128, 3, padding='same', activation='relu'),
  layers.MaxPooling2D(),
  layers.Dropout(0.2), #reduce overfitting, introduce dropout regularization to the network. it randomly drops out 20% of output units from the layer during the training process.
  layers.Flatten(),
